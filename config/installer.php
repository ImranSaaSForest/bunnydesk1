...
use App\Filament\Pages\ApplicationFields as PagesApplicationFields;
use App\Filament\Pages\Installer;
use App\Filament\Pages\SetupFields;
use App\Forms\Components\SetUpPage;
...
return [
    ...
    'steps' => [
        ...
        PagesApplicationFields::class,
        // SetupFields::class,
    ],

    'redirect_route' => "/",

    'installation_manager' => Installer::class,
    /*
    |--------------------------------------------------------------------------
    | Server Requirements
    |--------------------------------------------------------------------------
    ...
    */
    'applications'         => [
        ...
        'admin.email'    => [
            'label'    => 'Admin Email',
            'required' => true,
            'rules'    => 'string|max:100|unique:users,email',
            'default'  => ''
        ],
        'admin.password' => [
