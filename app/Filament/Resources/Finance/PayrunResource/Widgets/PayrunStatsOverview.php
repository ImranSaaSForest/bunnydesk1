...
class PayrunStatsOverview extends BaseWidget
{
    public $payrun;
    public $totalDeductionAmount;
    public $totalDeductionCount;
    public $totalAllowanceAmount;
    public $totalAllowanceCount;
    public $totalReimbursementAmount;
    public $totalReimbursementCount;
...
$payrunId=$payrun->id;
 ...
 $payrunTotalDeductionAmount=0;
        ...
        foreach ($users as $userId) {
            ...
            if ($payrunId) {
                ...
                if ($PayrollPolicy) {
                    ...
                    $this->totalAllowanceCount=count($allowances);
                    ...
                    $this->totalDeductionCount=count($deductions);
            ...
            $this->totalReimbursementCount+=Count($reimbursementRequests);
            ...
            $this->totalReimbursementAmount+=$reimbursementAmount;
        ...
        return [
            Stat::make('Total Gross Salary', round($totalGrossSalary,2))
           ,
            Stat::make('Total Tax Deduction', round($totalTax,2))
           ,
            Stat::make('Total Net Salary', round($totalNet,2))
            ,
            Stat::make('Total Allowance Count',$this->totalAllowanceCount),
            Stat::make('Total Deduction Count',$this->totalDeductionCount),
            Stat::make('Total Allowance Amount', round($payrunTotalAllowanceAmount,2))
           ,
            Stat::make('Total Deduction Amount', round($payrunTotalDeductionAmount,2))
           ,
            Stat::make('Total Employee Contribution Amount', round($totalEmployeeSocialSecurity,2))
           ,
            Stat::make('Total Employer Contribution Amount', round($totalEmployerSocialSecurity,2))
           ,
            Stat::make('Total Reimbursement Count',$this->totalReimbursementCount),

            Stat::make('Total Reimbursement Amount',$this->totalReimbursementAmount)
